...
<body>
    ...
    <script>
        ...
        {
            window.location.href = './mail/indexmail.php';
        }
        function navigateTochatAI() 
        {
            window.location.href = './chatAI/indexchat.php';
        }
        function navigateToTDS() 
        {
            window.location.href = './TDS/indexdata.php';
        }
        function navigateToIndexface() 
        {
            window.location.href = './randomface/indexface.php';
        }
